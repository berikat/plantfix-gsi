...
frappe.ui.form.on('Stock Entry', {
	...
	stock_entry_type: function (frm) {
		if (frm.doc.company && erpnext.is_perpetual_inventory_enabled(frm.doc.company)) {
			var fieldname = "stock_adjustment_account";
			if (frm.doc.stock_entry_type == "Material Receipt" || frm.doc.stock_entry_type == "Material Issue") {
				fieldname = "default_expense_account";
			}
			frm.add_fetch("company", fieldname, "expense_account");
			frm.call({
...
erpnext.stock.StockEntry = erpnext.stock.StockController.extend({
	setup: function () {
		...
		if (me.frm.doc.company && erpnext.is_perpetual_inventory_enabled(me.frm.doc.company)) {
			...
			this.frm.add_fetch("company", fieldname, "expense_account");
		}
